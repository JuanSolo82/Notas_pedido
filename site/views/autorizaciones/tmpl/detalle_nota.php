...
<script type="text/javascript" src="/portal/components/com_nota/assets/js/editar_nota.js"></script>
<br>
...
<div class='centrar'>
    <div class='fila_completa bordear centrar' style='width: 90%;'>
        ...
        <div class="col-1">
        <?php if ($user->authorise('maquinas_naves','com_nota') && $this->detalle_nota['enviado_empleado']==1 && $this->detalle_nota['autorizado_jefe']==0 && $this->detalle_nota['aprobado_adquisiciones']==0){ ?>
