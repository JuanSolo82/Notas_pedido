...
<div class='centrar'>
    <div class='fila_completa bordear centrar' style='width: 90%;'>
        ...
        <div class='col-6' style="display: block" id="destino">
            <?php echo $this->detalle_nota['depto_destino'] ?>
        </div>
        ...
        <div class="col-1">
            <a id="editar_destino" onclick="editar_destino()"><img src="/portal/administrator/templates/hathor/images/menu/icon-16-edit.png"></a>
            <!--<a onclick="editar_destino()" id='editar_destino'><img src="/portal/administrator/templates/hathor/images/menu/icon-16-edit.png"></a>
            <a onclick="cambiar_destino(<?php echo $this->detalle_nota['id_remitente'] ?>,'<?php echo $this->detalle_nota['nombre_remitente'] ? $this->detalle_nota['nombre_remitente'] : '' ?>')" id='cambiar_destino' style="display: none"><img src="/portal/administrator/templates/hathor/images/menu/icon-16-save.png"></a>
                -->
        </div>
    </div>
</div>
